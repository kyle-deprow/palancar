...
import type { AzureTokenProvider } from './azure-adapter.js';

export const AZURE_REALTIME_TOKEN_SCOPE = 'https://ai.azure.com/.default' as const;
  ...
  #startRefresh(): RefreshState {
    ...
    const promise = Promise.resolve()
      .then(async () => {
        ...
        try {
          rawToken = await this.#credential.getToken(AZURE_REALTIME_TOKEN_SCOPE, {
